...
module.exports = function(options) {
    ...
    var umzug = new Umzug({
        // Storarge type: 'json', 'sequelize', an object
        storage: 'sequelize',
        storageOptions: {
            // Sequelize instance
            sequelize: options.sequelize,
            // Name of the table containing the migration files which have been executed
            tableName: 'MigrationFiles',
            // The column name holding migration filename
            columnName: 'migration',
            // The type of the column holding migration name.
            columnType: options.Sequelize.STRING(255)
        },
        ...
        migrations: {
            ...
            params: [options.sequelize.getQueryInterface(), options.Sequelize],
    ...
    var schemaVersion = new SchemaVersion(options);
